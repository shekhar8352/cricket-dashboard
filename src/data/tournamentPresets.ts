...
export const indianTournamentPresets: TournamentPreset[] = [
  // Domestic Tournaments
  {
    ...
    venues: [
      ...
      'MA Chidambaram Stadium', 'Feroz Shah Kotla', 'Rajiv Gandhi International Stadium'
    ],
    duration: {
  ...
  },
  {
    ...
    name: 'India Test Series (Home)',
    type: 'bilateral',
    format: 'Test',
    level: 'international',
    description: 'Bilateral Test series with India as home team',
    structure: {
      groupStage: false,
      knockoutStage: false,
      finalStage: false,
